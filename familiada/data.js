const FAMILIADA_DATA = [
    ...
    {
        question: "Jaki jest najczęstszy powód spóźnienia?",
        answers: [
    ...
    {
        question: "Co jest najczęściej w lodówce?",
        answers: [
...
{
        question: "Kto jest największym Polakiem w historii?",
        answers: [
            ...
            { text: "Robert Kubica", points: 5 }
              ...
              {
        question: "Powód chodzenia na siłownię?",
        answers: [
    ...
    {
        question: "Co najczęściej gubimy?",
        answers: [
     ...
     {
        question: "Miejsce w którym trzeba zachowac ciszę",
        answers: [
    ...
    {
        question: "Co ludzie udawiają że rozumieją",
        answers: [
...
{
        question: "Co ludzie robią gdy mówia 'zaraz wychodzę'",
        answers: [
...
{
        question: "Powód dla którego ktoś mówi 'to był błąd'",
        answers: [
            { text: "ślub", points: 48 },
